...
# pour avoir une vraie mesure de similarité sémantique, pas celle biaisée de ton modèle actuel.
MODEL_NAME = "sentence-transformers/all-MiniLM-L6-v2" 
DATASET_ID = "matis35/cf-synt_V2" # Ton dataset
OUTPUT_FILE = "train_hard_negatives_cleaned.json"

BATCH_SIZE = 128
CANDIDATES_TO_FETCH = 30   # On regarde large pour pouvoir filtrer
NUM_NEGATIVES_NEEDED = 2   # On veut 2 négatifs finaux
